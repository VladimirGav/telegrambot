...
$tgData['messageTextLower'] = \modules\botservices\services\sPrompt::instance()->removeBotName($tgData['message_text'], 'token');
if (stripos($tgData['messageTextLower'], '/token') !== false && !empty($BotSettings['enableWallets'])) {
    $tgData['messageTextLower'] = str_replace('/token', '', $tgData['messageTextLower']);
