...
echo download zip php and unzip in ./php
...
echo download zip nodejs and unzip in ./nodejs
...
REM powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install web3 bip39 ethereumjs-wallet fs fs-extra path puppeteer puppeteer-core request request-promise-native promise-poller puppeteer-extra puppeteer-extra-plugin-stealth node-telegram-bot-api sequelize mysql2"

echo web3
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install web3"
pause
echo bip39
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install bip39"
pause
echo ethereumjs-wallet
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install ethereumjs-wallet"
pause
echo fs
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install fs"
pause
echo fs-extra
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install fs-extra"
pause
echo path
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install path"
pause
echo puppeteer
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install puppeteer"
pause
echo puppeteer-core
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install puppeteer-core"
pause
echo request
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install request"
pause
echo request-promise-native
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install request-promise-native"
pause
echo promise-poller
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install promise-poller"
pause
echo puppeteer-extra
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install puppeteer-extra"
pause
echo puppeteer-extra-plugin-stealth
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install puppeteer-extra-plugin-stealth"
pause
echo node-telegram-bot-api
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install node-telegram-bot-api"
pause
echo sequelize
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install sequelize"
pause
echo mysql2
powershell -Command "%nodejs_path%\npm --prefix %nodejs_project_path% install mysql2"
pause
